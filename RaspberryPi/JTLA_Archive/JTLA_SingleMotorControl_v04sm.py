...
class ControlPanel(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        # Create horizontal layout for pos gain
        self.posgain_up_button = QtWidgets.QPushButton("UP")
        self.posgain_up_button.setMinimumHeight(40)
        self.posgain_up_button.clicked.connect(self.increase_pos) #UPDATE THIS
        self.posgain_up_button.setStyleSheet("""
            QPushButton {
                background-color: lightgrey;
                color: black;
                font-size: 15px;
        ...
        """)
        self.posgain_down_button = QtWidgets.QPushButton("DOWN")
        self.posgain_down_button.setMinimumHeight(40)
        self.posgain_down_button.clicked.connect(self.increase_pos) #UPDATE THIS
        self.posgain_down_button.setStyleSheet("""
            QPushButton {
                background-color: lightgrey;
                color: black;
                font-size: 15px;
        ...
        """)
        label_posgain = QtWidgets.QLabel("Pos Gain")	# Doesn't need self. because it's not updated by another function
        label_posgain.setAlignment(QtCore.Qt.AlignCenter)
        layout_posgain = QtWidgets.QHBoxLayout()
        layout_posgain.addWidget(label_posgain)
        layout_posgain.addWidget(self.posgain_up_button)
        layout_posgain.addWidget(self.posgain_down_button)
        
        # Create horizontal layout for vel gain
        layout_velgain = QtWidgets.QHBoxLayout()
        
        # Create horizontal layout for pos gain
        layout_velintgain = QtWidgets.QHBoxLayout()
        
        # Create horizontal layout for pos gain
        layout_bandwidth = QtWidgets.QHBoxLayout()
        
        # Create main layout
        layout = QtWidgets.QVBoxLayout()			# Create vertical layout
        ...
        layout.addLayout(layout_posgain)
